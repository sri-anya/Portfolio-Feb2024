  ...
  return (
    <div className='bg-[#141414] h-auto w-full'>
      ...
      <div className=' text-white flex flex-col '>
        ...
        <div className="about grid grid-cols-3 gap-10 m-10 ">
          <div id="menu" className="menu col-span-1  flex justify-center items-center h-full ">
          ...
          <div className="content  col-span-2 h-[99%]   overflow-y-auto no-scrollbar flex flex-col justify-center items-center gap-4 p-5">
